...
\begin{frame}{Modeling — Results}
  \begin{columns}[T]
    ...
    \vspace{0.5em}
    \textbf{Best:} ensemble on full player features at
    \alert{\textbf{0.13}} above Understat (0.91), \textbf{0.06} below
    uniform (1.10).

    \vspace{0.4em}
    \textbf{Accuracy:} 50.6\% on most-likely outcome
    vs 42\% always-home majority baseline.
  \end{columns}
\end{frame}
